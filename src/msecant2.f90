!===============================================================
! Multisecant methods for mixing, Type-II update on approximate
! Jacobian.
!
! Reference:
...
subroutine msecant2_mix(mixer,parallel,iter,nrep,xin,xout,ierr)
        ...
        if (restart) then
            ...
            if (mixer%en_stage==1 .and. res==sz) then
                ...
                if (info /= 0) then
                    ...
                    write(9,*) ' subroutine msecant2, info = ', info
                    ierr = 1
                else
